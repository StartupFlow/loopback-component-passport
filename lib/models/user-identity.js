...
module.exports = function (UserIdentity) {
  ...
  UserIdentity.login = function (
    ...
    app.models.Config.findById("webapp")
      .then((config) => config.data.authentication.syncAttributes)
      .then((canSyncAttributes) => {
                  ...
                  return identity.user(function (err, user) {
                    ...
                    if (!err && user) {
                      try {
                        ...
                        const conditionToSyncAttributes = canSyncAttributes
